...
import { MdClose, MdModeEdit, MdOutlineDeleteForever, MdAddCircleOutline, MdPrint, MdSend, MdKeyboardArrowLeft, MdKeyboardArrowRight, MdUploadFile } from 'react-icons/md';
...
export default function EnhancedTable() {
  ...
  return (
    <div className="containere">
      <Header />
      <SidBar />
      <h2 className='text-center mt-5 no-print'>List d'activiter de division ttetet</h2>
      <div className='d-flex m-5'>
        <button className="btns btn-adds no-print" >
          Exporter Excel<FaFileExcel />
        </button>
        <button className="btns btn-adds no-print" >
          Imprimer <MdPrint />
        </button>
